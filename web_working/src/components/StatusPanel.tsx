  ...
  return (
    <div className="bg-gray-800 rounded-lg p-4 flex gap-6">
      <div className="flex items-center gap-2">
        <Signal className={stats.connectionStatus === 'connected' ? 'text-green-500' : 'text-red-500'} />
        <div className="text-sm">
          <p className="text-gray-400">Status</p>
          <p className="font-medium">{stats.connectionStatus}</p>
        </div>
      </div>
      ...
      <div className="flex items-center gap-2">
        ...
        <div className="text-sm">
          ...
          <p className="font-medium">{stats.frameRate} fps</p>
        </div>
      </div>
      ...
      <div className="flex items-center gap-2">
        ...
        <div className="text-sm">
          ...
          <p className="font-medium">{stats.activeSensors}</p>
        </div>
      </div>
    </div>
  );
